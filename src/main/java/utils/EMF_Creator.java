...
public class EMF_Creator {
    ...
    private static EntityManagerFactory createEntityManagerFactory(boolean isTest) {
        ...
        String connection_string ="CONNECTION_STR_prog";
        ...
        if (isDeployed) {
            ...
            System.out.println("CONNECTION_STR -->" + System.getenv(connection_string));
            String user = System.getenv("USER");
            String pw = System.getenv("PW");
            String connection_str = System.getenv(connection_string);
